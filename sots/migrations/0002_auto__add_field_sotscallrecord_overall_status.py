...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SOTSCallRecord.overall_status'
        db.add_column(u'sots_sotscallrecord', 'overall_status',
                      self.gf('django.db.models.fields.CharField')(default='NI', max_length=4, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SOTSCallRecord.overall_status'
        db.delete_column(u'sots_sotscallrecord', 'overall_status')
