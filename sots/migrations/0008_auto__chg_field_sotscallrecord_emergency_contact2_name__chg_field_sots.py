...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SOTSCallRecord.emergency_contact2_name'
        db.alter_column(u'sots_sotscallrecord', 'emergency_contact2_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'SOTSCallRecord.emergency_contact1_name'
        db.alter_column(u'sots_sotscallrecord', 'emergency_contact1_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'SOTSCallRecord.emergency_contact1'
        db.alter_column(u'sots_sotscallrecord', 'emergency_contact1', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'SOTSCallRecord.emergency_contact2'
        db.alter_column(u'sots_sotscallrecord', 'emergency_contact2', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'SOTSCallRecord.emergency_contact2_name'
        db.alter_column(u'sots_sotscallrecord', 'emergency_contact2_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'SOTSCallRecord.emergency_contact1_name'
        db.alter_column(u'sots_sotscallrecord', 'emergency_contact1_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'SOTSCallRecord.emergency_contact1'
        db.alter_column(u'sots_sotscallrecord', 'emergency_contact1', self.gf('django.db.models.fields.CharField')(default='', max_length=15))

        # Changing field 'SOTSCallRecord.emergency_contact2'
        db.alter_column(u'sots_sotscallrecord', 'emergency_contact2', self.gf('django.db.models.fields.CharField')(default='', max_length=15))
