...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SOTSCallRecord.round3_landline_status'
        db.alter_column(u'sots_sotscallrecord', 'round3_landline_status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'SOTSCallRecord.round3_mobile2_status'
        db.alter_column(u'sots_sotscallrecord', 'round3_mobile2_status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'SOTSCallRecord.round3_mobile1_status'
        db.alter_column(u'sots_sotscallrecord', 'round3_mobile1_status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'SOTSCallRecord.round2_landline_status'
        db.alter_column(u'sots_sotscallrecord', 'round2_landline_status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'SOTSCallRecord.round3_emergency_contact2_status'
        db.alter_column(u'sots_sotscallrecord', 'round3_emergency_contact2_status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'SOTSCallRecord.round3_emergency_contact1_status'
        db.alter_column(u'sots_sotscallrecord', 'round3_emergency_contact1_status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))
        ...
        # Changing field 'SOTSCallRecord.round2_mobile2_status'
        db.alter_column(u'sots_sotscallrecord', 'round2_mobile2_status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'SOTSCallRecord.round2_mobile1_status'
        db.alter_column(u'sots_sotscallrecord', 'round2_mobile1_status', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

    def backwards(self, orm):

        # Changing field 'SOTSCallRecord.round3_landline_status'
        db.alter_column(u'sots_sotscallrecord', 'round3_landline_status', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'SOTSCallRecord.round3_mobile2_status'
        db.alter_column(u'sots_sotscallrecord', 'round3_mobile2_status', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'SOTSCallRecord.round3_mobile1_status'
        db.alter_column(u'sots_sotscallrecord', 'round3_mobile1_status', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'SOTSCallRecord.round2_landline_status'
        db.alter_column(u'sots_sotscallrecord', 'round2_landline_status', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'SOTSCallRecord.round3_emergency_contact2_status'
        db.alter_column(u'sots_sotscallrecord', 'round3_emergency_contact2_status', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'SOTSCallRecord.round3_emergency_contact1_status'
        db.alter_column(u'sots_sotscallrecord', 'round3_emergency_contact1_status', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'SOTSCallRecord.round1_sotsuser'
        db.alter_column(u'sots_sotscallrecord', 'round1_sotsuser_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sots.SOTSadmin'], on_delete=models.SET_NULL))

        # Changing field 'SOTSCallRecord.round2_mobile2_status'
        db.alter_column(u'sots_sotscallrecord', 'round2_mobile2_status', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'SOTSCallRecord.round2_mobile1_status'
        db.alter_column(u'sots_sotscallrecord', 'round2_mobile1_status', self.gf('django.db.models.fields.CharField')(max_length=4))
