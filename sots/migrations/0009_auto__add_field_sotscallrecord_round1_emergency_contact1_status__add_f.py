...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SOTSCallRecord.round1_emergency_contact1_status'
        db.add_column(u'sots_sotscallrecord', 'round1_emergency_contact1_status',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=4, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SOTSCallRecord.round1_emergency_contact2_status'
        db.add_column(u'sots_sotscallrecord', 'round1_emergency_contact2_status',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=4, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SOTSCallRecord.round2_emergency_contact1_status'
        db.add_column(u'sots_sotscallrecord', 'round2_emergency_contact1_status',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=4, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SOTSCallRecord.round2_emergency_contact2_status'
        db.add_column(u'sots_sotscallrecord', 'round2_emergency_contact2_status',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SOTSCallRecord.round1_emergency_contact1_status'
        db.delete_column(u'sots_sotscallrecord', 'round1_emergency_contact1_status')

        # Deleting field 'SOTSCallRecord.round1_emergency_contact2_status'
        db.delete_column(u'sots_sotscallrecord', 'round1_emergency_contact2_status')

        # Deleting field 'SOTSCallRecord.round2_emergency_contact1_status'
        db.delete_column(u'sots_sotscallrecord', 'round2_emergency_contact1_status')

        # Deleting field 'SOTSCallRecord.round2_emergency_contact2_status'
        db.delete_column(u'sots_sotscallrecord', 'round2_emergency_contact2_status')
